...
public class DisparoDetras extends Mejoras{
	public DisparoDetras(Juego1 juego) {
		super(juego);
		setTextura(Assets.mejora_disparoDetras);
	...
	public void draw(Canvas g) {
		...
		if(box.intersect(nave.getBox())){
			...
			juego.getNave().setDetras(true);

			juego.getOMensajes().add(new Mensaje(new Vector2D(posicionMejora.getX(),posicionMejora.getY()), true, "Diarrea", juego,60));
