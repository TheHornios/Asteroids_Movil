...
public class Sicosis extends Mejoras{
	public Sicosis(Juego1 juego) {
		super(juego);
		setTextura(Assets.mejora_sicosis);
	...
	public void draw(Canvas g) {
		...
		g.drawBitmap(textura,null,e,g2);		if(box.intersect(nave.getBox())){
			...
			Settings.sicosis = true;
			juego.getOMensajes().add(new Mensaje(new Vector2D(posicionMejora.getX(),posicionMejora.getY()), true, "Sicosis", juego,60));
