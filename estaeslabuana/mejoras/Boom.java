...
public class Boom extends Mejoras{
	public Boom(Juego1 juego) {
		super(juego);
		setTextura(Assets.mejora_boom);
	...
	public void draw(Canvas g) {
		...
		if(box.intersect(nave.getBox())){
			...
			if(juego.boom()){
				...
				juego.getOMensajes().add(new Mensaje(new Vector2D(posicionMejora.getX(),posicionMejora.getY()),true,"BOOOOM", juego,60));
