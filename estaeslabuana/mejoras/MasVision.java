...
public class MasVision extends Mejoras{
	public MasVision(Juego1 juego) {
		super(juego);
		setTextura(Assets.mejora_masVision);
	...
	public void draw(Canvas g) {
        ...
        g.drawBitmap(textura,null,e,g2);		if(box.intersect(nave.getBox())){
			...
			juego.setVision(false);

			juego.getOMensajes().add(new Mensaje(new Vector2D(posicionMejora.getX(),posicionMejora.getY()), true, "Mas vision", juego,60));
