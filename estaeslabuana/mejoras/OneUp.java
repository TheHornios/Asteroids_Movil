...
public class OneUp extends Mejoras{
	public OneUp(Juego1 juego) {
		super(juego);
		setTextura(Assets.mejora_1up);
	...
	public void draw(Canvas g) {
		...
		if(box.intersect(nave.getBox())){
			...
			juego.getHud().setVidas();
			juego.getOMensajes().add(new Mensaje(new Vector2D(posicionMejora.getX(),posicionMejora.getY()), true, "1 Vida Mas", juego,60));
