...
public class FireRateDown extends Mejoras{
	public FireRateDown(Juego1 juego) {
		super(juego);
		setTextura(Assets.mejora_fireRateDow);
	...
	public void draw(Canvas g) {
		...
		if(box.intersect(nave.getBox())){
			...
			juego.getOMensajes().add(new Mensaje(new Vector2D(posicionMejora.getX(),posicionMejora.getY()), true, "Fire Rate Down", juego,60));
