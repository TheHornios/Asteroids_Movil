...
public class MilPts extends Mejoras{

	public MilPts(Juego1 juego) {
		super(juego);
		setTextura(Assets.mejora_1000pts);
	...
	public void draw(Canvas g) {
		...
		g.drawBitmap(textura,null,e,g2);		if(box.intersect(nave.getBox())){
			...
			juego.getHud().setPts1000();
			juego.getOMensajes().add(new Mensaje(new Vector2D(posicionMejora.getX(),posicionMejora.getY()), true, "5000 PTS", juego,60));
